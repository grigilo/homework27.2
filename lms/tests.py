...
class LessonTestCase(APITestCase):
    def setUp(self):
        ...
        self.course = Course.objects.create(
            title="Course", description="Course", owner=self.user
        )
        self.lesson = Lesson.objects.create(
            title="Lesson", description="Lesson", owner=self.user, course=self.course
        )
...
class SubscribeTestCase(APITestCase):
    ...
    def test_subscribe_create(self):
        ...
        self.assertEqual(response.json(), {"message": "Subscribe created successfully"})
    ...
    def test_subscribe_delete(self):
        ...
        self.assertEqual(response.json(), {"message": "Subscribe deleted successfully"})
